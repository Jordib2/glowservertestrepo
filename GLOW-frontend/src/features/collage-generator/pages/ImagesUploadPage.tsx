...
export default function ImagesUploadPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const video_url = await generateVideo(formData, (frame, total) => {
        setProgress(frame);
      });
      setProgress(300);
    ...
    <div className="min-h-screen bg-cover bg-center p-4 md:p-8" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <div className="w-full px-4 md:px-8">
        <div className="flex items-center justify-between mb-3">
          <button className="text-white text-2xl md:text-4xl w-12 h-12 md:w-16 md:h-16 flex items-center justify-center">←</button>
